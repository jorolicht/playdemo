...
val pagesMap = List(Auth, Console, PgError,
                    ...
                    ViewOrganizer, MainView, TourneyNew, CompetitionNew, TourneyInfo, TourneyRegistration, TourneyAdmin, Mockup, CompetitionInfo, PlayerRegistration, UserRegistration, UserLogin, VerifyAccount, StageAdmin, StageDraw, StageInput, StageResult, StageScoreSheet, StageCertificate, PlayerList, ResultList, Certificate, MainSearch)
