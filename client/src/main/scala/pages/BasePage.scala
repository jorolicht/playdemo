...
val pagesMap = List(Auth, Console, PgError,
                    ChatExample, 
                    ViewOrganizer, MainView, TourneyNew, CompetitionNew, TourneyInfo, Mockup, CompetitionInfo, PlayerRegistration, UserRegistration, UserLogin, VerifyAccount, StageAdmin, StageDraw, StageInput, StageResult, StageScoreSheet, StageCertificate, PlayerList, ResultList, Certificate, MainSearch)
