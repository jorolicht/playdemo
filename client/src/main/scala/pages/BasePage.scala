...
val pagesMap = List(pages.Home, Auth, Console, PgError,
                    ...
                    UseCase511, UseCase512, UseCase53, ViewOrganizer, MainMulti, NewTourney, InfoTourney, Mockup, InfoCompetition, RoundCFG, RoundDRW, RoundINP, RoundRES, PlayerList, ResultList, Certificate, MainSearch)
